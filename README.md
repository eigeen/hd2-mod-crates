...
“更新 Mod 版本”会检查 Unit 版本、旧顶点格式和原版 repatcher 使用的 LOD 数据。
经过样本确认的 `10800437 → 10800438` 路径只修改版本号和顶点格式；其他版本会在
安全检查通过后同步当前游戏的 LOD group。普通装备迁移与手动 Patch 合并不会自动
执行这项更新，GPU 和 stream sidecar 始终原样保留。
